    ...
    <div class="arzdigital-main-header">
        <div class="container">
            <div class="header-content">
                ...
                <!-- Auth Buttons -->
                <?php if (get_option('crypto_sekhyab_show_auth_buttons', '1') === '1') : ?>
...
jQuery(document).ready(function($) {
    ...
    function updateHeaderOffset() {
        ...
        if (!Number.isFinite(computed) || computed <= 0) {
            computed = Math.ceil($header.outerHeight(true)) || 95;
        }
        // حداکثر 95px
        computed = Math.min(computed, 95);
